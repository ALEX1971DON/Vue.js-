...
/*
Счетчик -----------------------------------------------
//создание глобального компонента
const app = Vue.createApp({});

//компонент(название, обьект со свойством шаблона)
app.component("counter",
	...
	<button v-on:click="consoleShow"> Консоле </button>
	
	`,
	});
//связываем Vue с эл-том на странице
app.mount("#app");
